...
public class Adapter_reject2 extends ArrayAdapter<String> {
    private final Activity context;
    private final String[] nama_item;
    Typeface font,fontbold;


    public Adapter_reject2(Activity context, String[] nama_item) {
        super(context, R.layout.item_reject2, nama_item);
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        View rowView=inflater.inflate(R.layout.item_reject2, null,true);
