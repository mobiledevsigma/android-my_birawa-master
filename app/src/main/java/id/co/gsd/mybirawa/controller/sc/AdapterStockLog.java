...
public class AdapterStockLog extends BaseAdapter {
    ...
    public AdapterStockLog(Activity context, ArrayList<HashMap<String,String>> d) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        if(view == null) {
            ...
            view = inflater.inflate(R.layout.item_list_stock_log, null);
            ...
            if(dat.get("qty_tambah").equals("null")){
                int jml = Integer.parseInt(dat.get("qty_stock").replace("null","0")) - Integer.parseInt(dat.get("qty_kurang").replace("null","0"));
                txtTitle.setText("Waktu : " + dat.get("updated_date")+"\n"+
                        "Stok sebelum : " + dat.get("qty_stock")+" unit\n"+
                        "Status : " + dat.get("types")+" sebanyak "+dat.get("qty_kurang")+" unit\n"+
                        "Stok setelah : " + jml);
            }else{
                int jml = Integer.parseInt(dat.get("qty_stock")) + Integer.parseInt(dat.get("qty_tambah"));
                txtTitle.setText("Waktu : " + dat.get("updated_date")+"\n"+
                        "Stok sebelum : " + dat.get("qty_stock")+" unit\n"+
                        "Status : " + dat.get("types")+" sebanyak "+dat.get("qty_tambah")+" unit\n"+
                        "Stok setelah : " + jml+" unit");
            }
