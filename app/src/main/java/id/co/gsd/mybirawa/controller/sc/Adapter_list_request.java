...
public class Adapter_list_request extends ArrayAdapter<String> {
    private final Activity context;
    private final String[] nama_item;
    Typeface font,fontbold;


    public Adapter_list_request(Activity context, String[] nama_item) {
        super(context, R.layout.item_list_request, nama_item);
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        View rowView=inflater.inflate(R.layout.item_list_request, null,true);
