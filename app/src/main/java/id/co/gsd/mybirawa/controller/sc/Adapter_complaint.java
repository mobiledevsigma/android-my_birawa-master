...
public class Adapter_complaint extends BaseAdapter {
    private final Activity context;
    ArrayList<HashMap<String,String>> data ;
    Typeface font,fontbold;


    public Adapter_complaint(Activity context, ArrayList<HashMap<String,String>> d) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        txtTitle_dua.setText("Tanggal complaint : "+dat.get("order_date"));
