...
public class Adapter_requestbm extends ArrayAdapter<String> {
    ...
    public Adapter_requestbm(Activity context, String[] no, String[] tanggal, String[] fm,String[] item, String[] jmlitem, String[] status) {
        super(context, R.layout.item_list_request_bm, no);
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        View rowView=inflater.inflate(R.layout.item_list_request_bm, null,true);
...
//                });
        ...
        goto_menu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                Intent i = new Intent(getContext(), detail_req_bmActivity.class);
                getContext().startActivity(i);
            }
        });
