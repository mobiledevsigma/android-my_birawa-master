...
public class Adapter_historycomplain extends ArrayAdapter<String> {
    ...
    public Adapter_historycomplain(Activity context, String[] no, String[] tanggal, String[] fm, String[] item, String[] jmlitem, String[] status) {
        super(context, R.layout.item_list_historycomplaint, no);
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        View rowView=inflater.inflate(R.layout.item_list_historycomplaint, null,true);
