...
public class ProsesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        font = Typeface.createFromAsset(ProsesActivity.this.getAssets(), "fonts/Nexa Light.otf");
        fontbold = Typeface.createFromAsset(ProsesActivity.this.getAssets(), "fonts/Nexa Bold.otf");
        ...
        goto_menu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                Intent i = new Intent(ProsesActivity.this, MenuActivity.class);
                startActivity(i);
            }
        });

        listmenu = (ListView) findViewById(R.id.list);
        Adapter_buktiorder adapter=new Adapter_buktiorder(ProsesActivity.this,nama_item);
