...
public class ModelChecklistInputBackup {
    ...
    public ModelChecklistInputBackup(String checklist_id, String checklist_name, String checklist_std, String checklist_type) {
    ...
    public ModelChecklistInputBackup(String deskripsi_id, String deskripsi) {
        this.deskripsi_id = deskripsi_id;
        this.deskripsi = deskripsi;
    }

    public ModelChecklistInputBackup(String checklist_id, String checklist_name, String checklist_std, String checklist_type, String deskripsi_id, String deskripsi, String isSeparator) {
        this.checklist_id = checklist_id;
        this.checklist_name = checklist_name;
        this.checklist_std = checklist_std;
        this.checklist_type = checklist_type;
