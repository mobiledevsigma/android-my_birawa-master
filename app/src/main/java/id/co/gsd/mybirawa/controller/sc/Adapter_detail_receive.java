...
public class Adapter_detail_receive extends ArrayAdapter<String> {
    ...
    public Adapter_detail_receive(Activity context, String[] no, String[] tanggal, String[] fm, String[] item, String[] jmlitem, String[] status) {
        super(context, R.layout.item_list_receive, no);
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        View rowView=inflater.inflate(R.layout.item_list_receive, null,true);
...
//                });
        ...
        goto_menu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                Intent i = new Intent(getContext(), Detail_receiveActivity.class);
                getContext().startActivity(i);
            }
        });
