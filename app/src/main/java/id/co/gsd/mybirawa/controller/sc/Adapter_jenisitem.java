...
public class Adapter_jenisitem extends ArrayAdapter<String> {
    ...
    public Adapter_jenisitem(final Activity context, String[] nama_items) {
        super(context, R.layout.item_jenis, nama_items);
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        View rowView=inflater.inflate(R.layout.item_jenis, null,true);
