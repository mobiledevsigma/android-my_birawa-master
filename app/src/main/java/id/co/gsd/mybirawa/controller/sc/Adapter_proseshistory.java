...
public class Adapter_proseshistory extends ArrayAdapter<String> {
    ...
    public Adapter_proseshistory(Activity context, String[] no, String[] tanggal, String[] fm, String[] item, String[] jmlitem, String[] status) {
        super(context, R.layout.item_proseshistory, no);
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        View rowView=inflater.inflate(R.layout.item_proseshistory, null,true);
...
//                });
        ...
        goto_menu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                Intent i = new Intent(getContext(), ProsesActivity.class);
                getContext().startActivity(i);
            }
        });
